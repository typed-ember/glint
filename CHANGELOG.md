...
#### :bug: Bug Fix
* `@glint/ember-tsc`
  * [#1248](https://github.com/typed-ember/glint/pull/1248) Fix `{{fn}}` with generic callbacks no longer inferring from the arg type ([@BoussonKarel](https://github.com/BoussonKarel))
* Other
...
#### :bug: Bug Fix
* `@glint/tsserver-plugin`
  * [#1064](https://github.com/typed-ember/glint/pull/1064) Gracefully turn off glint when no config at all is detected ([@NullVoxPopuli](https://github.com/NullVoxPopuli))
