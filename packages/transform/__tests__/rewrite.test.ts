  ...
  describe('ember-template-imports', () => {
    test('embedded gts templates', () => {
      ...
      expect(rewritten?.toDebugString()).toMatchInlineSnapshot(`
        ...
        | Mapping: Template
        |  hbs(22:74):   <template>\\\\n    Hello, {{this.target}}!\\\\n  </template>
        |  ts(22:380):   static { ({} as typeof import(\\"glint-environment-ember-template-imports/-private/dsl\\")).template(function(𝚪: import(\\"glint-environment-ember-template-imports/-private/dsl\\").ResolveContext<MyComponent>, χ: typeof import(\\"glint-environment-ember-template-imports/-private/dsl\\")) {\\\\n  χ.emitValue(χ.resolveOrReturn(𝚪.this.target)({}));\\\\n  𝚪; χ;\\\\n}) as unknown }
        |
        | | Mapping: Identifier
        | |  hbs(22:22):
        | |  ts(211:222):  MyComponent
        | |
        | | Mapping: MustacheStatement
        | |  hbs(44:59):   {{this.target}}
        | |  ts(302:354):  χ.emitValue(χ.resolveOrReturn(𝚪.this.target)({}))
        | |
        | | | Mapping: PathExpression
        | | |  hbs(46:57):   this.target
        | | |  ts(334:348):  𝚪.this.target
        | | |
        | | | | Mapping: Identifier
        | | | |  hbs(46:50):   this
        | | | |  ts(337:341):  this
    ...
    test('mixed expression and class uses', () => {
      ...
      expect(rewritten?.toDebugString()).toMatchInlineSnapshot(`
        ...
        |  ts(56:300):   ({} as typeof import(\\"glint-environment-ember-template-imports/-private/dsl\\")).template(function(𝚪, χ: typeof import(\\"glint-environment-ember-template-imports/-private/dsl\\")) {\\\\n  χ.emitValue(χ.resolveOrReturn(𝚪.args.message)({}));\\\\n  𝚪; χ;\\\\n})
        |
        | | Mapping: MustacheStatement
        | |  hbs(66:78):   {{@message}}
        | |  ts(234:287):  χ.emitValue(χ.resolveOrReturn(𝚪.args.message)({}))
        | |
        | | | Mapping: PathExpression
        | | |  hbs(68:76):   @message
        | | |  ts(266:281):  𝚪.args.message
        | | |
        | | | | Mapping: Identifier
        | | | |  hbs(69:76):   message
        | | | |  ts(274:281):  message
        ...
        |  ts(350:707):  static { ({} as typeof import(\\"glint-environment-ember-template-imports/-private/dsl\\")).template(function(𝚪: import(\\"glint-environment-ember-template-imports/-private/dsl\\").ResolveContext<MyComponent>, χ: typeof import(\\"glint-environment-ember-template-imports/-private/dsl\\")) {\\\\n  χ.emitValue(χ.resolveOrReturn(𝚪.this.title)({}));\\\\n  𝚪; χ;\\\\n}) as unknown }
        |
        | | Mapping: Identifier
        | |  hbs(139:139):
        | |  ts(539:550):  MyComponent
        | |
        | | Mapping: MustacheStatement
        | |  hbs(149:163): {{this.title}}
        | |  ts(630:681):  χ.emitValue(χ.resolveOrReturn(𝚪.this.title)({}))
        | |
        | | | Mapping: PathExpression
        | | |  hbs(151:161): this.title
        | | |  ts(662:675):  𝚪.this.title
        | | |
        | | | | Mapping: Identifier
        | | | |  hbs(151:155): this
        | | | |  ts(665:669):  this
